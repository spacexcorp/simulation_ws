...
echo_and_run cd "/home/user/simulation_ws/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/user/simulation_ws/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/user/simulation_ws/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
